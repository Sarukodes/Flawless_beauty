                ...
                <div class="row">
                    <div class="col-md-6 text">
                        ...
                        <p class="google">Or you can log In with email<br>
                            <a href="/auth/google/redirect" class="goo"> <i class="fa-brands fa-google"></i> Continue with google</a>
                         </p>
                        <div class="down">
                            Don't have an account? <a href="{{ route('auth.register') }}" class="">Signup</a>
                        </div>
                    </div>
                    <div class="col md 6">
